...
class OkHttpRequestMaker(
    ...
    override fun make(url: String, onResult: (result: String) -> Unit, onError:() -> Unit): Unit = run {
    ...
    fun showPreviousResult(file: File, onResult: (result: String) -> Unit, onError:() -> Unit) = run {
        try {
